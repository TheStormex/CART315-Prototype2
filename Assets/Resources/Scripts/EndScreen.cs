...
public class EndScreen : MonoBehaviour
{
    ...
    string loseInfo = "The host body you were in was defeated and thus, you also died! You lose! It is not easy being a mind-controlling magical parasite, but hey, what is?";
